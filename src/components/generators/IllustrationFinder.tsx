...
export default function IllustrationFinder() {
  const [searchTerm, setSearchTerm] = useState('');
  const [filterType, setFilterType] = useState<string>('all');

  // Collect all illustrations from archive
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Illustration Finder</h2>
